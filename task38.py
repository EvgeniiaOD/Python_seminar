...
#     # Преобразование строки user_data в список данных (предполагается, что данные разделены пробелами)
#     user_data_list = user_data.split()

#     # Проверка, что список данных содержит необходимое количество элементов (например, имя, фамилия, номер)
#     if len(user_data_list) >= 3:
#         first_name = user_data_list[0]
#         last_name = user_data_list[1]
#         number = user_data_list[2]

#         # Создание новой записи и добавление её в телефонную книгу
#         new_entry = {'first_name': first_name, 'last_name': last_name, 'number': number}
#         phone_book.append(new_entry)
#         print("Пользователь успешно добавлен.")
#     else:
#         print("Неверный формат данных. Должно быть: Имя Фамилия Номер")
